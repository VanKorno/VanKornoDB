...
fun intCol(name: String, defaultVal: Int = 0) = IntCol(name, defaultVal)
fun strCol(name: String, defaultVal: String = "") = StrCol(name, defaultVal)
fun boolCol(name: String, defaultVal: Boolean = false) = BoolCol(name, defaultVal)
fun longCol(name: String, defaultVal: Long = 0L) = LongCol(name, defaultVal)
fun floatCol(name: String, defaultVal: Float = 0F) = FloatCol(name, defaultVal)
fun blobCol(name: String, defaultVal: ByteArray = ByteArray(0)) = BlobCol(name, defaultVal)
...
fun intListCol(name: String, size: Int, defaultVal: Int = 0) = IntListCol(name, size, defaultVal)
fun strListCol(name: String, size: Int, defaultVal: String = "") = StrListCol(name, size, defaultVal)
fun boolListCol(name: String, size: Int, defaultVal: Boolean = false) = BoolListCol(name, size, defaultVal)
fun longListCol(name: String, size: Int, defaultVal: Long = 0L) = LongListCol(name, size, defaultVal)
fun floatListCol(name: String, size: Int, defaultVal: Float = 0F) = FloatListCol(name, size, defaultVal)
fun blobListCol(name: String, size: Int, defaultVal: ByteArray = ByteArray(0)) = BlobListCol(name, size, defaultVal)
