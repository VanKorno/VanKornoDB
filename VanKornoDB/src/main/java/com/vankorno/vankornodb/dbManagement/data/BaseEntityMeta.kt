 ...
 *
 * @property shemaBundle the current bundle of the entity class and its ways of interacting with db (generated by the IDE plugin).
...
interface BaseEntityMeta {
    ...
    val shemaBundle: CurrSchemaBundle<*>
