...
/**
 * Uses the setter, generated by the IDE plugin. If it doesn't exist - defaults to reflection-based mapping.
 */
@PublishedApi
internal fun <T : NormalEntity> toCV(                                obj: T,
                                                            schemaBundle: NormalSchemaBundle<out T>,
): ContentValues {
    @Suppress("UNCHECKED_CAST")
    val setter = schemaBundle.setter as ((T, ContentValues) -> ContentValues)?
    
    return setter?.invoke(obj, ContentValues())
        ?: toCV(obj, schemaBundle.clazz)
}
 ...
 * @param clazz The KClass of the entity.
