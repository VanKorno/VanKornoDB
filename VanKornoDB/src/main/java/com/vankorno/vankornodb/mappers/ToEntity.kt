...
**/
// endregion
package com.vankorno.vankornodb.mappers

import android.database.Cursor
import com.vankorno.vankornodb.dbManagement.data.BaseEntity
import com.vankorno.vankornodb.dbManagement.data.BaseSchemaBundle
import com.vankorno.vankornodb.mappers.EntityMapperUtils.defaultInstanceValueOf
import com.vankorno.vankornodb.mappers.EntityMapperUtils.getListFromCursor
import com.vankorno.vankornodb.mappers.EntityMapperUtils.getListSizeFromDefault
import com.vankorno.vankornodb.mappers.EntityMapperUtils.getNullable
...
/**
 * Uses the getter, generated by the IDE plugin. If it doesn't exist - defaults to reflection-based mapping.
 */
internal fun <T : BaseEntity> Cursor.toEntt(                       schemaBundle: BaseSchemaBundle<T>
): T = schemaBundle.getter?.invoke(this)
    ?: toEntt(schemaBundle.clazz)
 ...
 */
internal fun <T : BaseEntity> Cursor.toEntt(                                     clazz: KClass<T>
): T {
